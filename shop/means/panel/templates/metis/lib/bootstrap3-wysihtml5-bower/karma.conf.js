...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'components/bootstrap/dist/scripts/bootstrap.min.js', watched: false, included: true, served: true},
      ...
      //CSS
      {pattern: 'components/bootstrap/dist/styles/*.min.css', watched: false, included: true, served: true},
