...
این README بر اساس مستندات اولیه پروژه تهیه شده و می‌تواند در ادامه با اطلاعات دقیق‌تر شامل ساختار دیتابیس، راهنمای استقرار، نام کاربری پیش‌فرض پنل مدیریت و توضیحات API تکمیل شود.
