...
StyleSwitcher.prototype.build = function () {
    ...
    var modalHTML = '<div id="getCSSModal" class="modal fade">' +
        ...
        '<code>Copy textarea content and paste into theme.styles</code>' +
        '</div> ' +
    ...
    if (itm.ci) {
        ...
        var colorSelStyle = $('<link/>')
            .attr({
                'rel': 'stylesheet',
                'href': imgPath + 'assets/lib/colorpicker/styles/colorpicker.css'
            }),
            colorSelHackStyle = $('<link/>').attr({
                'rel': 'stylesheet',
                'href': imgPath + 'assets/styles/colorpicker_hack.css'
            });
        ...
        var url = imgPath + 'assets/lib/colorpicker/scripts/bootstrap-colorpicker.js';
